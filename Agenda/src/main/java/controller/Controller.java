...
public class Controller extends HttpServlet {
	...
	protected void contatos(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// criando ujm objeto que ira receber os dados javabeans
	...
	protected void listarContato(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// recebimento do id do contato q sera editado
		String idcon = request.getParameter("idcon");
		// setar variavel javabeans
		contato.setIdcon(idcon);
		// executar o metodod selecionarContato (dao)
		dao.selecionarContato(contato);
		// setar os atributos do formulario com o conteudo javabens
